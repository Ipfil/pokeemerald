...
#define OBJ_EVENT_GFX_UNUSED_ALEVINUS_DOLL        78
...
#define OBJ_EVENT_GFX_BIG_THERIFLOR_DOLL          180
#define OBJ_EVENT_GFX_BIG_CRAMOCHUS_DOLL         181
#define OBJ_EVENT_GFX_BIG_DUNKLEUS_DOLL         182
