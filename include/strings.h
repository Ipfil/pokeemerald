...
extern const u8 gText_TheriflorDoll256BP[];
extern const u8 gText_CramochusDoll256BP[];
extern const u8 gText_DunkleusDoll256BP[];
...
extern const u8 gTrickHouse_Mechadoll_Sensigrain[];
