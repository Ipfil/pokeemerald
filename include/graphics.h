...
extern const u32 gMonFrontPic_Griffleur[];
extern const u32 gMonPalette_Griffleur[];
extern const u32 gMonBackPic_Griffleur[];
extern const u32 gMonShinyPalette_Griffleur[];
extern const u32 gMonStillFrontPic_Griffleur[];
extern const u8 gMonIcon_Griffleur[];
extern const u8 gMonFootprint_Griffleur[];
extern const u32 gMonFrontPic_Theriflor[];
extern const u32 gMonPalette_Theriflor[];
extern const u32 gMonBackPic_Theriflor[];
extern const u32 gMonShinyPalette_Theriflor[];
extern const u32 gMonStillFrontPic_Theriflor[];
extern const u8 gMonIcon_Theriflor[];
extern const u8 gMonFootprint_Theriflor[];
extern const u32 gMonFrontPic_Feuzard[];
extern const u32 gMonPalette_Feuzard[];
extern const u32 gMonBackPic_Feuzard[];
extern const u32 gMonShinyPalette_Feuzard[];
extern const u32 gMonStillFrontPic_Feuzard[];
extern const u8 gMonIcon_Feuzard[];
extern const u8 gMonFootprint_Feuzard[];
...
extern const u32 gMonFrontPic_Cramochus[];
extern const u32 gMonPalette_Cramochus[];
extern const u32 gMonBackPic_Cramochus[];
extern const u32 gMonShinyPalette_Cramochus[];
extern const u32 gMonStillFrontPic_Cramochus[];
extern const u8 gMonIcon_Cramochus[];
extern const u8 gMonFootprint_Cramochus[];
extern const u32 gMonFrontPic_Alevinus[];
extern const u32 gMonPalette_Alevinus[];
extern const u32 gMonBackPic_Alevinus[];
extern const u32 gMonShinyPalette_Alevinus[];
extern const u32 gMonStillFrontPic_Alevinus[];
extern const u8 gMonIcon_Alevinus[];
extern const u8 gMonFootprint_Alevinus[];
extern const u32 gMonFrontPic_Blindalvin[];
extern const u32 gMonPalette_Blindalvin[];
extern const u32 gMonBackPic_Blindalvin[];
extern const u32 gMonShinyPalette_Blindalvin[];
extern const u32 gMonStillFrontPic_Blindalvin[];
extern const u8 gMonIcon_Blindalvin[];
extern const u8 gMonFootprint_Blindalvin[];
extern const u32 gMonFrontPic_Dunkleus[];
extern const u32 gMonPalette_Dunkleus[];
extern const u32 gMonBackPic_Dunkleus[];
extern const u32 gMonShinyPalette_Dunkleus[];
extern const u32 gMonStillFrontPic_Dunkleus[];
extern const u8 gMonIcon_Dunkleus[];
extern const u8 gMonFootprint_Dunkleus[];
...
extern const u32 gMonFrontPic_Drododo[];
extern const u32 gMonPalette_Drododo[];
extern const u32 gMonBackPic_Drododo[];
extern const u32 gMonShinyPalette_Drododo[];
extern const u32 gMonStillFrontPic_Drododo[];
extern const u8 gMonIcon_Drododo[];
extern const u8 gMonFootprint_Drododo[];
extern const u32 gMonFrontPic_Rapidro[];
extern const u32 gMonPalette_Rapidro[];
extern const u32 gMonBackPic_Rapidro[];
extern const u32 gMonShinyPalette_Rapidro[];
extern const u32 gMonStillFrontPic_Rapidro[];
extern const u8 gMonIcon_Rapidro[];
extern const u8 gMonFootprint_Rapidro[];
extern const u32 gMonFrontPic_Drotonerre[];
extern const u32 gMonPalette_Drotonerre[];
extern const u32 gMonBackPic_Drotonerre[];
extern const u32 gMonShinyPalette_Drotonerre[];
extern const u32 gMonStillFrontPic_Drotonerre[];
extern const u8 gMonIcon_Drotonerre[];
extern const u8 gMonFootprint_Drotonerre[];
extern const u32 gMonFrontPic_Racoupan[];
extern const u32 gMonPalette_Racoupan[];
extern const u32 gMonBackPic_Racoupan[];
extern const u32 gMonShinyPalette_Racoupan[];
extern const u32 gMonStillFrontPic_Racoupan[];
extern const u8 gMonIcon_Racoupan[];
extern const u8 gMonFootprint_Racoupan[];
extern const u32 gMonFrontPic_Razorus[];
extern const u32 gMonPalette_Razorus[];
extern const u32 gMonBackPic_Razorus[];
extern const u32 gMonShinyPalette_Razorus[];
extern const u32 gMonStillFrontPic_Razorus[];
extern const u8 gMonIcon_Razorus[];
extern const u8 gMonFootprint_Razorus[];
...
extern const u32 gMonFrontPic_Sensigrain[];
extern const u32 gMonPalette_Sensigrain[];
extern const u32 gMonBackPic_Sensigrain[];
extern const u32 gMonShinyPalette_Sensigrain[];
extern const u32 gMonStillFrontPic_Sensigrain[];
extern const u8 gMonIcon_Sensigrain[];
extern const u8 gMonFootprint_Sensigrain[];
...
extern const u32 gDecorIcon_TheriflorDoll[];
extern const u32 gDecorIconPalette_TheriflorDoll[];
extern const u32 gDecorIcon_CramochusDoll[];
extern const u32 gDecorIconPalette_CramochusDoll[];
extern const u32 gDecorIcon_DunkleusDoll[];
extern const u32 gDecorIconPalette_DunkleusDoll[];
