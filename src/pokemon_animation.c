...
static const u8 sSpeciesToBackAnimSet[] =
{
    ...
    [SPECIES_GRIFFLEUR] = BACK_ANIM_H_SLIDE,
    [SPECIES_THERIFLOR] = BACK_ANIM_HORIZONTAL_SHAKE,
    [SPECIES_FEUZARD] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_CHARMELEON] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_CRAMOCHUS] = BACK_ANIM_FADE_RED_WITH_SHAKE,
    [SPECIES_ALEVINUS] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_BLINDALVIN] = BACK_ANIM_CONCAVE_UP_ARC_SWAY_LARGE,
    [SPECIES_DUNKLEUS] = BACK_ANIM_FADE_BLUE_WITH_SHAKE,
    ...
    [SPECIES_DRODODO] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_RAPIDRO] = BACK_ANIM_JOLT_RIGHT,
    [SPECIES_DROTONERRE] = BACK_ANIM_CIRCLE_MOVE_CLOCKWISE,
    [SPECIES_RACOUPAN] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    [SPECIES_RAZORUS] = BACK_ANIM_V_SHAKE_WITH_H_SLIDE,
    ...
    [SPECIES_SENSIGRAIN] = BACK_ANIM_H_SLIDE,
