const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_GRIFFLEUR] = sGriffleurLevelUpLearnset,
    [SPECIES_THERIFLOR] = sTheriflorLevelUpLearnset,
    [SPECIES_FEUZARD] = sFeuzardLevelUpLearnset,
    [SPECIES_CHARMELEON] = sCharmeleonLevelUpLearnset,
    [SPECIES_CRAMOCHUS] = sCramochusLevelUpLearnset,
    [SPECIES_ALEVINUS] = sAlevinusLevelUpLearnset,
    [SPECIES_BLINDALVIN] = sBlindalvinLevelUpLearnset,
    [SPECIES_DUNKLEUS] = sDunkleusLevelUpLearnset,
    ...
    [SPECIES_DRODODO] = sDrododoLevelUpLearnset,
    [SPECIES_RAPIDRO] = sRapidroLevelUpLearnset,
    [SPECIES_DROTONERRE] = sDrotonerreLevelUpLearnset,
    [SPECIES_RACOUPAN] = sRacoupanLevelUpLearnset,
    [SPECIES_RAZORUS] = sRazorusLevelUpLearnset,
    ...
    [SPECIES_SENSIGRAIN] = sSensigrainLevelUpLearnset,
