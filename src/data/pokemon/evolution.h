...
{
    [SPECIES_BULBASAUR]  = {{EVO_LEVEL, 16, SPECIES_GRIFFLEUR}},
    [SPECIES_GRIFFLEUR]    = {{EVO_LEVEL, 32, SPECIES_THERIFLOR}},
    [SPECIES_FEUZARD] = {{EVO_LEVEL, 16, SPECIES_CHARMELEON}},
    [SPECIES_CHARMELEON] = {{EVO_LEVEL, 36, SPECIES_CRAMOCHUS}},
    [SPECIES_ALEVINUS]   = {{EVO_LEVEL, 16, SPECIES_BLINDALVIN}},
    [SPECIES_BLINDALVIN]  = {{EVO_LEVEL, 36, SPECIES_DUNKLEUS}},
    ...
    [SPECIES_DRODODO]     = {{EVO_LEVEL, 18, SPECIES_RAPIDRO}},
    [SPECIES_RAPIDRO]  = {{EVO_LEVEL, 36, SPECIES_DROTONERRE}},
    [SPECIES_RACOUPAN]    = {{EVO_LEVEL, 20, SPECIES_RAZORUS}},
    ...
    [SPECIES_SENSIGRAIN]     = {{EVO_LEVEL, 21, SPECIES_GLOOM}},
