const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_DUNKLEUS] =
    {
        .categoryName = _("SHELLFISH"),
        .height = 16,
        .weight = 855,
        .description = gDunkleusPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_RAPIDRO] =
    {
        .categoryName = _("BIRD"),
        .height = 11,
        .weight = 300,
        .description = gRapidroPokedexText,
        .pokemonScale = 331,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_SENSIGRAIN] =
    {
        .categoryName = _("WEED"),
        .height = 5,
        .weight = 54,
        .description = gSensigrainPokedexText,
        .pokemonScale = 423,
        .pokemonOffset = 19,
        .trainerScale = 256,
        .trainerOffset = 0,
