...
const u16 DecorGfx_THERIFLOR_DOLL[] = {
    OBJ_EVENT_GFX_BIG_THERIFLOR_DOLL
};

const u16 DecorGfx_CRAMOCHUS_DOLL[] = {
    OBJ_EVENT_GFX_BIG_CRAMOCHUS_DOLL
};

const u16 DecorGfx_DUNKLEUS_DOLL[] = {
    OBJ_EVENT_GFX_BIG_DUNKLEUS_DOLL
};
