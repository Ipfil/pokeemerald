const struct Decoration gDecorations[] =
{
    ...
    [DECOR_THERIFLOR_DOLL] =
    {
        .id = DECOR_THERIFLOR_DOLL,
        .name = _("THERIFLOR DOLL"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_DOLL,
        .price = 10000,
        .description = DecorDesc_THERIFLOR_DOLL,
        .tiles = DecorGfx_THERIFLOR_DOLL,
    },
    ...
    [DECOR_DUNKLEUS_DOLL] =
    {
        .id = DECOR_DUNKLEUS_DOLL,
        .name = _("DUNKLEUS DOLL"),
        .permission = DECORPERM_SPRITE,
        .shape = DECORSHAPE_1x2,
        .category = DECORCAT_DOLL,
        .price = 10000,
        .description = DecorDesc_DUNKLEUS_DOLL,
        .tiles = DecorGfx_DUNKLEUS_DOLL,
    },
