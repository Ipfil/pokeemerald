const u32 *const gDecorIconTable[][2] = 
{
    ...
    [DECOR_THERIFLOR_DOLL]   = {gDecorIcon_TheriflorDoll, gDecorIconPalette_TheriflorDoll},
    [DECOR_CRAMOCHUS_DOLL]  = {gDecorIcon_CramochusDoll, gDecorIconPalette_CramochusDoll},
    [DECOR_DUNKLEUS_DOLL]  = {gDecorIcon_DunkleusDoll, gDecorIconPalette_DunkleusDoll},
