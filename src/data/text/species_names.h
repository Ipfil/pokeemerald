const u8 gSpeciesNames[][POKEMON_NAME_LENGTH + 1] = {
    ...
    [SPECIES_GRIFFLEUR] = _("GRIFFLEUR"),
    [SPECIES_THERIFLOR] = _("THERIFLOR"),
    [SPECIES_FEUZARD] = _("FEUZARD"),
    [SPECIES_CHARMELEON] = _("CHARMELEON"),
    [SPECIES_CRAMOCHUS] = _("CRAMOCHUS"),
    [SPECIES_ALEVINUS] = _("ALEVINUS"),
    [SPECIES_BLINDALVIN] = _("BLINDALVIN"),
    [SPECIES_DUNKLEUS] = _("DUNKLEUS"),
    ...
    [SPECIES_DRODODO] = _("DRODODO"),
    [SPECIES_RAPIDRO] = _("RAPIDRO"),
    [SPECIES_DROTONERRE] = _("DROTONERRE"),
    [SPECIES_RACOUPAN] = _("RACOUPAN"),
    [SPECIES_RAZORUS] = _("RAZORUS"),
    ...
    [SPECIES_SENSIGRAIN] = _("SENSIGRAIN"),
