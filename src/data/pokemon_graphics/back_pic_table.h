const struct CompressedSpriteSheet gMonBackPicTable[] =
{
    ...
    SPECIES_SPRITE(GRIFFLEUR, gMonBackPic_Griffleur),
    SPECIES_SPRITE(THERIFLOR, gMonBackPic_Theriflor),
    SPECIES_SPRITE(FEUZARD, gMonBackPic_Feuzard),
    SPECIES_SPRITE(CHARMELEON, gMonBackPic_Charmeleon),
    SPECIES_SPRITE(CRAMOCHUS, gMonBackPic_Cramochus),
    SPECIES_SPRITE(ALEVINUS, gMonBackPic_Alevinus),
    SPECIES_SPRITE(BLINDALVIN, gMonBackPic_Blindalvin),
    SPECIES_SPRITE(DUNKLEUS, gMonBackPic_Dunkleus),
    ...
    SPECIES_SPRITE(DRODODO, gMonBackPic_Drododo),
    SPECIES_SPRITE(RAPIDRO, gMonBackPic_Rapidro),
    SPECIES_SPRITE(DROTONERRE, gMonBackPic_Drotonerre),
    SPECIES_SPRITE(RACOUPAN, gMonBackPic_Racoupan),
    SPECIES_SPRITE(RAZORUS, gMonBackPic_Razorus),
    ...
    SPECIES_SPRITE(SENSIGRAIN, gMonBackPic_Sensigrain),
