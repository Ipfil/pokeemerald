const struct CompressedSpritePalette gMonPaletteTable[] =
{
    ...
    SPECIES_PAL(GRIFFLEUR, gMonPalette_Griffleur),
    SPECIES_PAL(THERIFLOR, gMonPalette_Theriflor),
    SPECIES_PAL(FEUZARD, gMonPalette_Feuzard),
    SPECIES_PAL(CHARMELEON, gMonPalette_Charmeleon),
    SPECIES_PAL(CRAMOCHUS, gMonPalette_Cramochus),
    SPECIES_PAL(ALEVINUS, gMonPalette_Alevinus),
    SPECIES_PAL(BLINDALVIN, gMonPalette_Blindalvin),
    SPECIES_PAL(DUNKLEUS, gMonPalette_Dunkleus),
    ...
    SPECIES_PAL(DRODODO, gMonPalette_Drododo),
    SPECIES_PAL(RAPIDRO, gMonPalette_Rapidro),
    SPECIES_PAL(DROTONERRE, gMonPalette_Drotonerre),
    SPECIES_PAL(RACOUPAN, gMonPalette_Racoupan),
    SPECIES_PAL(RAZORUS, gMonPalette_Razorus),
    ...
    SPECIES_PAL(SENSIGRAIN, gMonPalette_Sensigrain),
