const struct CompressedSpriteSheet gMonFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(GRIFFLEUR, gMonFrontPic_Griffleur),
    SPECIES_SPRITE(THERIFLOR, gMonFrontPic_Theriflor),
    SPECIES_SPRITE(FEUZARD, gMonFrontPic_Feuzard),
    SPECIES_SPRITE(CHARMELEON, gMonFrontPic_Charmeleon),
    SPECIES_SPRITE(CRAMOCHUS, gMonFrontPic_Cramochus),
    SPECIES_SPRITE(ALEVINUS, gMonFrontPic_Alevinus),
    SPECIES_SPRITE(BLINDALVIN, gMonFrontPic_Blindalvin),
    SPECIES_SPRITE(DUNKLEUS, gMonFrontPic_Dunkleus),
    ...
    SPECIES_SPRITE(DRODODO, gMonFrontPic_Drododo),
    SPECIES_SPRITE(RAPIDRO, gMonFrontPic_Rapidro),
    SPECIES_SPRITE(DROTONERRE, gMonFrontPic_Drotonerre),
    SPECIES_SPRITE(RACOUPAN, gMonFrontPic_Racoupan),
    SPECIES_SPRITE(RAZORUS, gMonFrontPic_Razorus),
    ...
    SPECIES_SPRITE(SENSIGRAIN, gMonFrontPic_Sensigrain),
