const u8 *const gMonFootprintTable[] =
{
    ...
    [SPECIES_GRIFFLEUR] = gMonFootprint_Griffleur,
    [SPECIES_THERIFLOR] = gMonFootprint_Theriflor,
    [SPECIES_FEUZARD] = gMonFootprint_Feuzard,
    [SPECIES_CHARMELEON] = gMonFootprint_Charmeleon,
    [SPECIES_CRAMOCHUS] = gMonFootprint_Cramochus,
    [SPECIES_ALEVINUS] = gMonFootprint_Alevinus,
    [SPECIES_BLINDALVIN] = gMonFootprint_Blindalvin,
    [SPECIES_DUNKLEUS] = gMonFootprint_Dunkleus,
    ...
    [SPECIES_DRODODO] = gMonFootprint_Drododo,
    [SPECIES_RAPIDRO] = gMonFootprint_Rapidro,
    [SPECIES_DROTONERRE] = gMonFootprint_Drotonerre,
    [SPECIES_RACOUPAN] = gMonFootprint_Racoupan,
    [SPECIES_RAZORUS] = gMonFootprint_Razorus,
    ...
    [SPECIES_SENSIGRAIN] = gMonFootprint_Sensigrain,
