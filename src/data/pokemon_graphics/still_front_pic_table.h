const struct CompressedSpriteSheet gMonStillFrontPicTable[] =
{
    ...
    SPECIES_SPRITE(CRAMOCHUS,     gMonStillFrontPic_Cramochus),
    SPECIES_SPRITE(ALEVINUS,      gMonStillFrontPic_Alevinus),
    SPECIES_SPRITE(BLINDALVIN,     gMonStillFrontPic_Blindalvin),
    SPECIES_SPRITE(DUNKLEUS,     gMonStillFrontPic_Dunkleus),
    ...
    SPECIES_SPRITE(DRODODO,        gMonStillFrontPic_Drododo),
    SPECIES_SPRITE(RAPIDRO,     gMonStillFrontPic_Rapidro),
    SPECIES_SPRITE(DROTONERRE,       gMonStillFrontPic_Drotonerre),
    SPECIES_SPRITE(RACOUPAN,       gMonStillFrontPic_Racoupan),
    SPECIES_SPRITE(RAZORUS,      gMonStillFrontPic_Razorus),
    ...
    SPECIES_SPRITE(SENSIGRAIN,        gMonStillFrontPic_Sensigrain),
