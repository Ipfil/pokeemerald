const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
    ...
    SPECIES_SHINY_PAL(GRIFFLEUR, gMonShinyPalette_Griffleur),
    SPECIES_SHINY_PAL(THERIFLOR, gMonShinyPalette_Theriflor),
    SPECIES_SHINY_PAL(FEUZARD, gMonShinyPalette_Feuzard),
    SPECIES_SHINY_PAL(CHARMELEON, gMonShinyPalette_Charmeleon),
    SPECIES_SHINY_PAL(CRAMOCHUS, gMonShinyPalette_Cramochus),
    SPECIES_SHINY_PAL(ALEVINUS, gMonShinyPalette_Alevinus),
    SPECIES_SHINY_PAL(BLINDALVIN, gMonShinyPalette_Blindalvin),
    SPECIES_SHINY_PAL(DUNKLEUS, gMonShinyPalette_Dunkleus),
    ...
    SPECIES_SHINY_PAL(DRODODO, gMonShinyPalette_Drododo),
    SPECIES_SHINY_PAL(RAPIDRO, gMonShinyPalette_Rapidro),
    SPECIES_SHINY_PAL(DROTONERRE, gMonShinyPalette_Drotonerre),
    SPECIES_SHINY_PAL(RACOUPAN, gMonShinyPalette_Racoupan),
    SPECIES_SHINY_PAL(RAZORUS, gMonShinyPalette_Razorus),
    ...
    SPECIES_SHINY_PAL(SENSIGRAIN, gMonShinyPalette_Sensigrain),
