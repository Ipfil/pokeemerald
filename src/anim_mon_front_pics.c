...
const u32 gMonFrontPic_Griffleur[] = INCBIN_U32("graphics/pokemon/griffleur/anim_front.4bpp.lz");
const u32 gMonFrontPic_Theriflor[] = INCBIN_U32("graphics/pokemon/theriflor/anim_front.4bpp.lz");
const u32 gMonFrontPic_Feuzard[] = INCBIN_U32("graphics/pokemon/feuzard/anim_front.4bpp.lz");
const u32 gMonFrontPic_Charmeleon[] = INCBIN_U32("graphics/pokemon/charmeleon/anim_front.4bpp.lz");
const u32 gMonFrontPic_Cramochus[] = INCBIN_U32("graphics/pokemon/cramochus/anim_front.4bpp.lz");
const u32 gMonFrontPic_Alevinus[] = INCBIN_U32("graphics/pokemon/alevinus/anim_front.4bpp.lz");
const u32 gMonFrontPic_Blindalvin[] = INCBIN_U32("graphics/pokemon/blindalvin/anim_front.4bpp.lz");
const u32 gMonFrontPic_Dunkleus[] = INCBIN_U32("graphics/pokemon/dunkleus/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Drododo[] = INCBIN_U32("graphics/pokemon/drododo/anim_front.4bpp.lz");
const u32 gMonFrontPic_Rapidro[] = INCBIN_U32("graphics/pokemon/rapidro/anim_front.4bpp.lz");
const u32 gMonFrontPic_Drotonerre[] = INCBIN_U32("graphics/pokemon/drotonerre/anim_front.4bpp.lz");
const u32 gMonFrontPic_Racoupan[] = INCBIN_U32("graphics/pokemon/racoupan/anim_front.4bpp.lz");
const u32 gMonFrontPic_Razorus[] = INCBIN_U32("graphics/pokemon/razorus/anim_front.4bpp.lz");
...
const u32 gMonFrontPic_Sensigrain[] = INCBIN_U32("graphics/pokemon/sensigrain/anim_front.4bpp.lz");
