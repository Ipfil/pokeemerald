...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_CRAMOCHUS] = gMonIcon_Cramochus,
    [SPECIES_ALEVINUS] = gMonIcon_Alevinus,
    [SPECIES_BLINDALVIN] = gMonIcon_Blindalvin,
    [SPECIES_DUNKLEUS] = gMonIcon_Dunkleus,
    ...
    [SPECIES_DRODODO] = gMonIcon_Drododo,
    [SPECIES_RAPIDRO] = gMonIcon_Rapidro,
    [SPECIES_DROTONERRE] = gMonIcon_Drotonerre,
    [SPECIES_RACOUPAN] = gMonIcon_Racoupan,
    [SPECIES_RAZORUS] = gMonIcon_Razorus,
    ...
    [SPECIES_SENSIGRAIN] = gMonIcon_Sensigrain,
